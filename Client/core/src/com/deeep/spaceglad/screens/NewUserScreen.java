...
public class NewUserScreen implements Screen{
    ...
    private Label usernameLabel, passwordLabel, messageLabel, firstNameLabel, lastNameLabel, emailLabel, affiliationLabel;
    ...
    private void configureWidgets() {
        ...
        createButton.setPosition(Core.VIRTUAL_WIDTH / 2 - createButton.getWidth() - 10,
        ...
        emailArea.setPosition(Core.VIRTUAL_WIDTH / 2 - emailArea.getWidth() - 10,
                Core.VIRTUAL_HEIGHT / 2 - 75 - 20);
        emailLabel.setSize(128, 32);
        emailLabel.setPosition(Core.VIRTUAL_WIDTH / 2 - emailArea.getWidth() - 10,
                Core.VIRTUAL_HEIGHT / 2 - 75);
        usernameLabel.setSize(128, 32);
        usernameLabel.setPosition(Core.VIRTUAL_WIDTH / 2 - emailArea.getWidth() - 10,
                Core.VIRTUAL_HEIGHT / 2 + 75);
        usernameArea.setSize(150, 28);
        usernameArea.setPosition(Core.VIRTUAL_WIDTH / 2 - emailArea.getWidth() - 10,
                Core.VIRTUAL_HEIGHT / 2 + 75 - 20);
        passwordLabel.setSize(128, 32);
        passwordLabel.setPosition(Core.VIRTUAL_WIDTH / 2 - emailArea.getWidth() - 10,
                Core.VIRTUAL_HEIGHT / 2 );
        passwordArea.setSize(150, 28);
        passwordArea.setPosition(Core.VIRTUAL_WIDTH / 2 - emailArea.getWidth() - 10,
                Core.VIRTUAL_HEIGHT / 2 - 20);
        firstNameLabel.setSize(128, 32);
        firstNameLabel.setPosition(Core.VIRTUAL_WIDTH / 2  + 10,
                Core.VIRTUAL_HEIGHT / 2 + 75);
        firstNameArea.setSize(150, 28);
        firstNameArea.setPosition(Core.VIRTUAL_WIDTH / 2 +  10,
                Core.VIRTUAL_HEIGHT / 2 + 75 - 20);
        lastNameLabel.setSize(128, 32);
        lastNameLabel.setPosition(Core.VIRTUAL_WIDTH / 2 +  10,
                Core.VIRTUAL_HEIGHT / 2 );
        lastNameArea.setSize(150, 28);
        lastNameArea.setPosition(Core.VIRTUAL_WIDTH / 2 +  10,
                Core.VIRTUAL_HEIGHT / 2 - 20);
        affiliationLabel.setSize(128, 32);
        affiliationLabel.setPosition(Core.VIRTUAL_WIDTH / 2 +  10,
                Core.VIRTUAL_HEIGHT / 2 - 75);
        affiliationArea.setSize(150, 28);
        affiliationArea.setPosition(Core.VIRTUAL_WIDTH / 2 +  10,
                Core.VIRTUAL_HEIGHT / 2 - 75 - 20);
